...
/**
 * Шифровать пароль каждый раз, когда он изменяется
 *
 * @type {String}
 */
...
/**
 * Проверить уникальный не удаленный адрес электронной почты пользователя
 *
 * @type {String}
 */
...
/**
 * Простой плагин для Mongoose, который добавляет createdAt и updatedAt атрибуты даты, которые
 * автоматически присваивается самой последней отметке времени создания / обновления.
 *
 * @type {Dates}
 */
