...
var config = {
    ...
    ssl: {
        ca: fs.readFileSync("certs/ca.crt")
            .toString(),
        key: fs.readFileSync("certs/client.max.key")
            .toString(),
        cert: fs.readFileSync("certs/client.max.crt")
            .toString()
    }
};

// выполните пакет операторов как атомарную транзакцию для перевода средств с одной учетной записи на другую,
// а затем прочитайте обновленные значения, где все включенные операторы либо фиксируются, либо прерываются.
